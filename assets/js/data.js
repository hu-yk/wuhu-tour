...
var IMG = {
  ...
  farmingPlant:   'assets/images/耕作插秧1.jpg',
  farmerWork:     'assets/images/农民工作1.jpg',
  FiRuM:          'assets/images/FiRuM.jpg',
  gMygx:          'assets/images/gMygx.jpg',
...
var VILLAGE_DATA = {
  ...
  annualVisitors: '约 15 万人次',
  annualTourismRevenue: '约 200 万元',
  incomeIncrease: '户均增收约 1.8 万元',
  formerIncome: '原农民打工年均收入约 10 万元',
  dailyWage: '约 100 元/天',
  volunteerStipend: '约 150 元/天（研学志愿者）',
...
var STORIES = [
  { id:'museum001', title:'云梦县博物馆', type:'总书记考察足迹',
    content:'2024年11月，习近平总书记在湖北省孝感市考察云梦县博物馆。7月16日实践队完成博物馆研学与拍摄。',
  ...
  { id:'jian001', title:'云梦秦汉简牍', type:'传统文化资源',
    ...
    img: IMG.museumVisit, source:'云梦县博物馆展陈', status:'已采集' },
  ...
  { id:'wulao001', title:'"读懂中国"——"五老"专访', type:'人物故事',
    ...
    action:'用五老的人生故事诠释理想信念和长征精神。',
    img: IMG.meeting, source:'2026-07-18 现场采访', status:'采集中' },
  { id:'village001', title:'伍湖村乡村振兴故事', type:'乡土叙事',
    content:'通过村干部访谈、农户交流和产业走访，记录伍湖村从生态农业到农旅融合的发展故事。',
    action:'用青年视角讲好伍湖村产业振兴和文化振兴故事。',
    img: IMG.farmerWork, source:'7月17-18日 现场访谈', status:'采集中' }
];

// ── 稻虾产业模块 ──
var AGRICULTURE_MODULES = [
  { title:'稻虾共作', tag:'生态农业',
    desc:'全村稻虾共作面积 6300 亩。水稻年产约 700 万斤，小龙虾亩产约 400 斤。形成"一田双收、绿色循环"的生态种养模式。',
    img: IMG.farmingPlant, source:'陈书记（2026-07-17）' },
  { title:'生产周期', tag:'全年种养',
    desc:'3-4月投放虾苗 + 水稻育秧；5-6月龙虾生长旺季、分批捕捞；6月中水稻插秧、稻虾共生；9-10月水稻收割、虾稻米上市。',
    img: IMG.farmerWork, source:'产业负责人（2026-07-17）' },
  { title:'双水双绿', tag:'绿色技术',
    desc:'围绕绿色水稻、绿色水产协同发展，展示生态农业技术在伍湖村产业升级中的应用。',
    img: IMG.FiRuM, source:'梦辰泽农业' },
  { title:'梦辰泽农业', tag:'产业主体',
    desc:'湖北梦辰泽生态农业有限公司是伍湖村稻虾产业的核心经营主体，负责种养技术、加工、品牌和销售。',
    img: IMG.gMygx, source:'企业负责人（2026-07-17）' },
  { title:'农户增收', tag:'产业效益',
    desc:'户均增收约 1.8 万元。原农民打工年均约 10 万元。村民务工约 100 元/天，研学志愿者约 150 元/天。全村 518 户、2130 人。',
    img: IMG.farmerWork, source:'陈书记（2026-07-17）' },
  { title:'农旅融合', tag:'旅游数据',
    desc:'年接待游客约 15 万人次，旅游综合收入约 200 万元。伍湖四海生态园为主要承载点位。',
    img: IMG.gMygx, source:'陈书记（2026-07-17）' }
];
...
var FIELD_DATA = {
  ...
  owner:'湖北梦辰泽生态农业有限公司',
  story:'伍湖村依托 6300 亩稻虾共作基地，年产虾稻米约 700 万斤。全村 518 户、2130 人，人均耕地 1.1 亩，户均增收约 1.8 万元。稻在水中长，虾在田中游——一块田串联起生态农业、特色产品和农旅体验。',
...
var ROUTES = [
  { id:'route001', name:'伍湖农文旅半日路线', time:'约3-4小时',
    ...
    img: IMG.farmingPlant, desc:'适合实践队调研农业、文化和旅游资源。' },
  { id:'route002', name:'循迹云梦研学路线', time:'约半日',
    ...
    img: IMG.museumExterior, desc:'适合学生党员循迹研学和文化传承主题展示。' },
  { id:'route003', name:'亲子生态体验路线', time:'约2-3小时',
    ...
    img: IMG.gMygx, desc:'适合游客体验生态农业与农旅融合。' }
];
