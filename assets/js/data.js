...
var STORIES = [
  ...
  { id:'jian001', title:'云梦睡虎地秦简', type:'传统文化资源',
    content:'睡虎地秦简是云梦最具代表性的文化遗产，包括为吏之道、编年纪等珍贵简牍。',
  ...
  { id:'foot001', title:'总书记考察足迹', type:'循迹悟思想',
    ...
    img: IMG.meetingTotal, source:'实践队综合整理', status:'已整理' },
  { id:'red001', title:'龚华铭烈士纪念广场', type:'红色文化',
    content:'7月16日实践队完成纪念广场走访与拍摄，瞻仰烈士纪念碑与烈士像。',
  ...
  { id:'wulao001', title:'"读懂中国"——"五老"专访', type:'人物故事',
    ...
    img: IMG.meetingTotal, source:'2026-07-18 现场采访', status:'已完成' },
